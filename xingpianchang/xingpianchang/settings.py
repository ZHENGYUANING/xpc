...
BOT_NAME = 'xingpianchang'

SPIDER_MODULES = ['xingpianchang.spiders']
NEWSPIDER_MODULE = 'xingpianchang.spiders'
...
DOWNLOADER_MIDDLEWARES = {
   'xingpianchang.middlewares.RandomProxyMiddleware': 749,
}
...
ITEM_PIPELINES = {
    'xingpianchang.pipelines.MysqlPipeline': 300,
